...
A scatterplot of each data point in the dataset with a best fit line shows a positive relationship between the percentage of the population who have completed a Bachelor's equivalent education and the average daily household income. However, the correlation does not appear to be very strong because there is a lot of variation in the points.
