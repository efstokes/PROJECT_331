...
library(patchwork)
HS_plot <- gapminder|>
  ggplot(mapping = aes(x = HighSchool_pct, y = DailyIncome)) + 
  geom_point()+
  geom_smooth(method = "lm")+
  labs(x = "Percent of Population Completion",
       y = "Daily Income (PPP Dollars)",
       title = "High-School Equivalent Acheivement")
...
BA_plot <- gapminder|>
  ...
  labs(x = "Percent of Population Completion",
       y = "Daily Income (PPP Dollars)",
       title = "Bachelors Equivalent Achievement")
HS_plot+BA_plot
