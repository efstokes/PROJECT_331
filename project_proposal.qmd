...
full_bachelors |> 
  ggplot()+
  geom_point(mapping = aes(x = sim_income, y = income))+
  geom_abline(slope = 1, intercept = 0)+
  labs(x = "Simulated Income",
       y = "Observed Income",
       title = "Simulated vs Observed Income Based on Observed Bachelor's Attainment %")
```
